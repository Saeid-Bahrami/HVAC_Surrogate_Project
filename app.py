...
# فعال‌سازی CORS جهت ارتباط بدون مانع با کلاینت‌ها و سرورهای خارجی
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # در محیط تولید واقعی می‌توان به دامنه‌های مشخص محدود کرد
...
if __name__ == "__main__":
    import uvicorn
    # اجرای مستقیم جهت تست محلی با پورت 7860 (پورت پیش‌فرض HuggingFace Spaces)
